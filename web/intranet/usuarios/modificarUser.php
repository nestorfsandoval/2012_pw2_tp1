...
<form id="form-editar-user-<?php echo $?>" class="panelUser" action="index.php?op=2" method="POST">
        <input type="hidden" name="acc" value="editar">
        <label>Nombre:</label>
        <input id="name" type="text" name="mnombre"><br/>	
        <label>Apellido:</label>
        <input id="apellido" type="text" name="mapellido"><br/>	
        <label>Usuario:</label>
